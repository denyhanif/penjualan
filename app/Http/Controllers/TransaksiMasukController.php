...
class TransaksiMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $produk = Produk::find($input['kd_produk']);//mengambil data produk sesuai kode
        $data['stok'] = $produk->stok + $input['jumlah'];
        $produk->update($data);
        return redirect()->route('transaksi_masuk.index')->with('status','Transaksi Masuk BErhasil Ditmbahkan');
    }
    ...
    {
        $transaksi_masuk = TransaksiMasuk::findOrFail($id); //ambil data transaksi
        $jumlah= $transaksi_masuk->jumlah;// ambil jumlah transaksi masuk sesuai id
        ...
        return redirect()->route('transaksi_masuk.index')->with('status','Transaksi Berhasil Dihapus');
