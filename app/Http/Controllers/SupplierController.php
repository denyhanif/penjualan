...
class SupplierController extends Controller
{
    ...
    {
        $supplier = Supplier::paginate(5);//metod paginate di gunakan untuk mengambil data berdasarkan pagign ==setiap halaman di talpilkan 2 resource
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validasi->fails()){
            return redirect()->route('supllier.edit',[$id])->withErrors($validasi);
        ...
        return redirect()->route('supplier.index')->with('status','data supplier berhasil di ubah');
    }
