...
class CreateTransaksiDetailTableee extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaksi_detaill', function (Blueprint $table) {
            $table->increments('kd_transaksi_detaill');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('transaksi_detaill');
    }
}
