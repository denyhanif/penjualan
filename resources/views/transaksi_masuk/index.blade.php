                    ...
                    <tbody>
                        @foreach($transaksi_masuk as $row)
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="{{ route('transaksi_masuk.destroy',[$row->kd_transaksi_masuk])}} " onsubmit="return confirm('Apakah anda yakin akan menghapus data transaksi ini?')">
                                    @csrf
                                    {{method_field('DELETE')}}
