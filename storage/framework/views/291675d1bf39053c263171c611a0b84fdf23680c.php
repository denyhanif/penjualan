...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('img/userlogo.png')); ?>" class="user-image" alt="User Image">
              <?php if(Auth::check()): ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo e(asset('img/userlogo.png')); ?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php echo $__env->make('subview.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\penjualan\resources\views/layouts/template.blade.php ENDPATH**/ ?>